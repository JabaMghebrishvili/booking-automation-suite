...
public class DetailsPage {
    ...
    public DetailsPage(Page page) {
        this.page = page;
        this.searchBoxLayout = page.getByTestId("searchbox-layout-wide"); // .locator("span")
        this.startDate = searchBoxLayout.getByTestId("date-display-field-start"); // .locator("span")
        this.endDate = searchBoxLayout.getByTestId("date-display-field-end");
        this.title = page.locator("#hp_hotel_name h2"); //div[@id='hp_hotel_name']//h2
    ...
    public Locator getTitle() {
        return page.locator("#hp_hotel_name h2");
    }

    public Locator getReviewScore() {
        return page.getByTestId("review-score-right-component").locator("div.bc946a29db");
    }

    public Locator getPrice() {
        return page.locator("span.prco-valign-middle-helper").first();
    }
}
